...
CREATE TABLE `likes` (
  ...
  KEY `likeActionId_idx` (`actionId`),
  CONSTRAINT `likeActionId` FOREIGN KEY (`actionId`) REFERENCES `actions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `likes` VALUES (5,1,7);
